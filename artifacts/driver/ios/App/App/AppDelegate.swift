...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // MARK: - Remote Notifications (APNs ↔ Capacitor PushNotifications)
    // Capacitor's PushNotifications plugin listens for these
    // NotificationCenter posts to emit the JS `registration` /
